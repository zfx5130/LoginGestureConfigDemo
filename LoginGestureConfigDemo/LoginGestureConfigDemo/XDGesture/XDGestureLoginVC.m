...
- (void)setupView
{
    ...
    [[UIBarButtonItem alloc] initWithTitle:@"Back" style:UIBarButtonItemStyleDone target:self action:@selector(dismiss)];
...
- (UIImageView *)backgroundImgView
{
    if (!_backgroundImgView) {
       ...
       // _backgroundImgView.image = [UIImage imageNamed:@"background"];
        _backgroundImgView.backgroundColor = [UIColor blackColor];
